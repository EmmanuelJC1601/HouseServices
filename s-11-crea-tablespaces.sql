...
create undo tablespace undo_prov
  datafile '/unam/bda/pf/c2/d01/undo_prov.dbf' size 100m
  autoextend on next 10m maxsize unlimited;

create temporary tablespace temp_prov
  tempfile '/unam/bda/pf/c0/d01/temp_prov_01.dbf' size 50m,
           '/unam/bda/pf/c0/d01/temp_prov_02.dbf' size 50m,
           '/unam/bda/pf/c0/d01/temp_prov_03.dbf' size 50m
  autoextend on next 10m maxsize unlimited;

create bigfile tablespace users_prov
  datafile '/unam/bda/pf/c1/d01/users_prov.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

alter database default temporary tablespace temp_prov;
alter database default tablespace users_prov;
...
create bigfile tablespace proveedores_c1_data_ts
  datafile '/unam/bda/pf/c1/d01/proveedores_c1_data_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

create bigfile tablespace proveedores_c0_idx_ts
  datafile '/unam/bda/pf/c0/d01/proveedores_c0_idx_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

create bigfile tablespace proveedores_c0_lob_hot_ts
  datafile '/unam/bda/pf/c0/d01/proveedores_c0_lob_hot_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  blocksize 8192
  extent management local autoallocate
  segment space management auto;
...
create bigfile tablespace proveedores_c2_lob_warm_ts
  datafile '/unam/bda/pf/c2/d01/proveedores_c2_lob_warm_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  blocksize 8192
  extent management local autoallocate
  segment space management auto;
...
create bigfile tablespace proveedores_c3_hist_ts
  datafile '/unam/bda/pf/c3/d01/proveedores_c3_hist_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;
...
create bigfile undo tablespace undo_serv
  datafile '/unam/bda/pf/c2/d02/undo_serv.dbf' size 100m 
  autoextend on next 10m maxsize unlimited;

create temporary tablespace temp_serv
  tempfile '/unam/bda/pf/c0/d02/temp_serv_01.dbf' size 50m,
           '/unam/bda/pf/c0/d02/temp_serv_02.dbf' size 50m,
           '/unam/bda/pf/c0/d02/temp_serv_03.dbf' size 50m
  autoextend on next 10m maxsize unlimited;

create bigfile tablespace users_serv
  datafile '/unam/bda/pf/c1/d02/users_serv.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

alter database default temporary tablespace temp_serv;
alter database default tablespace users_serv;
...
create bigfile tablespace servicios_c0_data_ts
  datafile '/unam/bda/pf/c0/d02/servicios_c0_data_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

create bigfile tablespace servicios_c0_idx_ts
  datafile '/unam/bda/pf/c0/d02/servicios_c0_idx_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;

create bigfile tablespace servicios_c0_lob_hot_ts
  datafile '/unam/bda/pf/c0/d02/servicios_c0_lob_hot_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  blocksize 8192
  extent management local autoallocate
  segment space management auto;
...
create bigfile tablespace servicios_c3_hist_ts
  datafile '/unam/bda/pf/c3/d02/servicios_c3_hist_ts.dbf' size 500m
  autoextend on next 10m maxsize unlimited
  extent management local autoallocate
  segment space management auto;
